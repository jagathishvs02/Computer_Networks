...
set tracefd  [open Reno_wandw.tr w]
set namtrace [open Reno_wandw.nam w]
$ns_ trace-all $tracefd
$ns_ namtrace-all-wireless $namtrace $opt(x) $opt(y)

set fa [open "tt_Reno_wandw.xg" "w"]

set f1 [open "tb_Reno_wandw.xg" "w"]
...
proc finish {} {
        ...
        close $tracefd
 	close $namtrace
	exec xgraph tt_Reno_wandw.xg tb_Reno_wandw.xg Reno_wandw1.xg Reno_wandw2.xg -geometry 300x300 &
        exec nam Reno_wandw.nam &
        exit 0
}
...
set outfile1 [open Reno_wandw1.xg w]
set outfile2 [open Reno_wand2.xg w]
