...
set tracefd  [open Tahoe_wandw.tr w]
set namtrace [open Tahoe_wandw.nam w]
$ns_ trace-all $tracefd
$ns_ namtrace-all-wireless $namtrace $opt(x) $opt(y)

set fa [open "tt_Tahoe_wandw.xg" "w"]

set f1 [open "tb_Tahoe_wandw.xg" "w"]
...
proc finish {} {
        ...
        close $tracefd
 	close $namtrace
	exec xgraph tt_Tahoe_wandw.xg tb_Tahoe_wandw.xg Tahoe_wandw1.xg Tahoe_wandw2.xg -geometry 300x300 &
...
set outfile1 [open Tahoe_wandw1.xg w]
set outfile2 [open Tahoe_wandw2.xg w]
