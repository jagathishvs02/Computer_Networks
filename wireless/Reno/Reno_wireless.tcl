...
set tracefile [open Reno_wireless.tr w]

$ns trace-all $tracefile
set namfile [open Reno_wireless.nam w]

$ns namtrace-all-wireless $namfile $val(x) $val(y)

set fa [open "tt_Reno_wireless.xg" "w"]

set f1 [open "tb_Reno_wireless.xg" "w"]
...
proc finish {} {
	...
	exec xgraph tt_Reno_wireless.xg tb_Reno_wireless.xg Reno_wireless1.xg Reno_wireless2.xg -geometry 300x300 &
        exec nam Reno_wireless.nam &
        exit 0
}
...
set outfile1 [open Reno_wireless1.xg w]
set outfile2 [open Reno_wireless2.xg w]
