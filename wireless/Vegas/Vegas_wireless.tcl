...
set tracefile [open Vegas_wireless.tr w]

$ns trace-all $tracefile
set namfile [open Vegas_wireless.nam w]

$ns namtrace-all-wireless $namfile $val(x) $val(y)

set fa [open "tt_Vegas_wireless.xg" "w"]

set f1 [open "tb_Vegas_wireless.xg" "w"]
...
proc finish {} {
	...
	exec xgraph tt_Vegas_wireless.xg tb_Vegas_wireless.xg Vegas_wireless1.xg Vegas_wireless2.xg -geometry 300x300 &
        exec nam Vegas_wireless.nam &
        exit 0
}
...
set outfile1 [open Vegas_wireless1.xg w]
set outfile2 [open Vegas_wireless2.xg w]
