...
set nf [open Vegas_grid.nam w]
$ns namtrace-all $nf

set nftr [open Vegas_grid.tr w]
$ns trace-all $nftr

set fa [open "tt_Vegas_grid.xg" "w"]

set f1 [open "tb_Vegas_grid.xg" "w"]
...
proc finish {} {
	...
	exec xgraph tt_Vegas_grid.xg tb_Vegas_grid.xg Vegas_grid1.xg Vegas_grid2.xg Vegas_grid3.xg -geometry 300x300 &
        exec nam Vegas_grid.nam &
        exit 0
...
set outfile1 [open Vegas_grid1.xg w]
set outfile2 [open Vegas_grid2.xg w]
set outfile3 [open Vegas_grid3.xg w]
