...
set nf [open Reno_grid.nam w]
$ns namtrace-all $nf

set nftr [open Reno_grid.tr w]
$ns trace-all $nftr

set fa [open "tt_Reno_grid.xg" "w"]

set f1 [open "tb_Reno_grid.xg" "w"]
...
proc finish {} {
	...
	exec xgraph tt_Reno_grid.xg tb_Reno_grid.xg Reno_grid1.xg Reno_grid2.xg Reno_grid3.xg -geometry 300x300 &
        exec nam Reno_grid.nam &
        exit 0
}
...
set outfile1 [open Reno_grid1.xg w]
set outfile2 [open Reno_grid2.xg w]
set outfile3 [open Reno_grid3.xg w]
